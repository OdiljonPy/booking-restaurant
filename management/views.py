...
class RestaurantViewSet(viewsets.ModelViewSet):
    ...
    #     rest_id = pk
    #     payments = Payment.objects.filter(restaurant_id=rest_id)
    ...
    #     total_revenue = Payment.objects.filter(restaurant_id=rest_id, date__range=[start_date, end_date]).aggregate(
